...
[![version](https://img.shields.io/badge/v3.6.88-图谱身份与告警-E8D5B5?style=flat-square&labelColor=3a3026&color=E8D5B5)](https://github.com/sdyckjq-lab/llm-wiki-skill/releases)
...
| ⚠️ | **图谱身份与告警** | 同名页面按知识库内相对路径分别保留；歧义、断链、待创建和路径冲突会集中提示，图谱仍可阅读，详情只读并按页加载；无效详情也不会把本机绝对路径带入离线文件 |
