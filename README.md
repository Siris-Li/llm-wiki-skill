...
[![version](https://img.shields.io/badge/v3.6.60-隐私保护-E8D5B5?style=flat-square&labelColor=3a3026&color=E8D5B5)](https://github.com/sdyckjq-lab/llm-wiki-skill/releases)
...
| 🔎 | **工作台统一质量检查** | 本机与 GitHub 使用同一入口，顺序检查公开内容隐私、前后台、共享规则、图谱、边界、类型、规范和构建，并在隔离环境验证启动与入口反例 |
