...
[![version](https://img.shields.io/badge/v3.6.62-Page%20Checks-E8D5B5?style=flat-square&labelColor=3a3026&color=E8D5B5)](https://github.com/sdyckjq-lab/llm-wiki-skill/releases)
...
| 🧪 | **Real Workbench Browser Checks** | Automated checks cover seven primary workflows plus isolation, cancellation, disconnects, busy states, and failure recovery through the real frontend and backend; Paper visual checks follow page search into the right reading drawer and confirm that page content is visible |
